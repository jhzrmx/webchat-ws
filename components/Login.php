	...
	<div class="bg-gray-300 h-screen flex items-center justify-center">
		<div class="bg-white p-8 rounded shadow-md w-96 m-12">
	        ...
	        <form id="myform" method="POST">
	            ...
	            <input type="password" id="password" name="password" class="w-full p-2 border-2 bg-gray-100 rounded focus:outline-none focus:border-blue-500 mb-6" maxlength="75" required>
	            <button type="submit" name="login" class="w-full p-2 rounded bg-blue-500 text-white hover:bg-blue-600 hover:cursor-pointer focus:bg-blue-600 mb-4">Login</button>
