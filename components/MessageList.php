...
function cardMessageList($fullname, $userId, $lastMessage) {
	...
	<li class="flex items-center mb-1">
		<button onclick="getMessages('<?php echo $userId ?>')" class="flex justify-start items-center w-full bg-gray-300 hover:bg-gray-50 hover:cursor-pointer p-2 rounded-lg overflow-hidden">
